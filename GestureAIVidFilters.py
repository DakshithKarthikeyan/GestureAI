...
def apply(img, t):
    ...
    if t == "NEGATIVE": return cv2.bitwise_not(img)  # FIXED
    ...
    if t == "EDGE": return cv2.Canny(cv2.cvtColor(img, cv2.COLOR_BGR2GRAY), 80, 160)  # FIXED
    if t == "CARTOON" :
...
while True:
    ...
    if res.multi_hand_landmarks:
        ...
        tx, ty = tips["thumb"]; ix,iy = tips["index"]  # FIXED spacing
